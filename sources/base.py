...
INDIA_KEYWORDS = [
    ...
    r'\bNIPFP\b', r'\bNCAER\b',
    r'\bIIM\b', r'\bIIT\b', r'\bISB\b',
    ...
    # Cities and states
    r'\bMumbai\b', r'\bDelhi\b', r'\bBangalore\b', r'\bBengaluru\b',
    r'\bChennai\b', r'\bHyderabad\b', r'\bKolkata\b', r'\bPune\b',
    ...
    r'\bJan Dhan\b', r'\bMake in India\b', r'\bGST\b',
]
